...
public class ForegroundService extends Service {
    ...
    private Notification makeNotification (JSONObject settings)
    {
        ...
        if (settings.optBoolean("allowClose", false)) {
            ...
            final PendingIntent closeIntent = PendingIntent.getBroadcast(context, 1337, clostAppIntent, PendingIntent.FLAG_UPDATE_CURRENT |
        ...
        if (intent != null && settings.optBoolean("resume")) {
            ...
            PendingIntent contentIntent = PendingIntent.getActivity(
                    context, NOTIFICATION_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
